      ...
      >
        ...
        <div class="mb-4">
          ...
          <input
            ...
            required
            class="w-full rounded-md border bg-neutral-200 border-neutral-300 px-3 py-2 dark:border-slate-500 dark:bg-slate-700 dark:focus:outline-none"
          />
        </div>
        <div class="mb-4">
          <label class="block text-gray-700 mb-1 dark:text-white"
          ...
          <textarea
            ...
            required
            class="w-full rounded-md border resize-none h-48 bg-neutral-200 border-neutral-300 px-3 py-2 dark:border-slate-500 dark:bg-slate-700 dark:focus:outline-none"
          ></textarea>
        </div>
        <div class="mb-6">
          ...
          <select
            ...
            class="w-full rounded-md border bg-neutral-200 border-neutral-300 px-3 py-2 cursor-pointer dark:border-slate-500 dark:bg-slate-700 dark:focus:outline-none"
          >
